...
API_ID = int(os.environ.get("API_ID", "24627174"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "0590457d36e07e903704daa3b99fb846")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "1386134836"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003473126138")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://lakhan:Lakhan94@cluster0.5uuw8wz.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
